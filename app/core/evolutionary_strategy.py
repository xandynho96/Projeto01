...
class EvolutionaryOptimizer:
    ...
    def initialize_population(self, regime=None):
        ...
        try:
            from app.core.llm_strategy import DeepSeekStrategist
        ...
        try:
            import json
            import os
            if os.path.exists(os.path.join('config', 'legacy_strategies.json')):
                with open(os.path.join('config', 'legacy_strategies.json'), 'r') as f:
