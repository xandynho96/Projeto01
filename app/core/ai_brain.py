...
import os
import joblib
from app.utils import script_utils # Import helper
...
class AIBrain:
    def __init__(self, model_filename=os.path.join('data', 'models', 'bitcoin_ai_model.pkl'), scaler_filename=os.path.join('data', 'models', 'scaler.pkl')):
